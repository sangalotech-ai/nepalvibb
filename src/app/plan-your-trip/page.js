                        ...
                        {!session?.user && (
                          <div className="space-y-8 order-1 lg:order-2">
                            <div className="bg-gray-50/50 rounded-[2.5rem] p-8 border-2 border-gray-100/50 space-y-8">
                              ...
                              <div className="space-y-4">
                                <Link 
                                  href="/login?callbackUrl=/plan-your-trip"
                                  className="w-full bg-primary text-white hover:bg-emerald-700 px-6 py-4 rounded-2xl text-xs font-black uppercase tracking-widest flex items-center justify-center space-x-3 shadow-md transition-all"
                                >
                                  <User className="w-4 h-4 text-emerald-100" />
                                  <span>{t.planTrip.login}</span>
                                </Link>
                              </div>
                            </div>
                          </div>
